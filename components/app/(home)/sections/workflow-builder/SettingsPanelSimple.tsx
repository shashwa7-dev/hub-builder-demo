...
//   const [serverConfig, setServerConfig] = useState<ServerAPIConfig | null>(
//     null
//   );
...
//   const upsertLLMKey = () => {};
//   const deleteLLMKey = () => {};
//   const toggleLLMKeyActive = () => {};

//   // MCP Registry state
//   const mcpServers = [] as MCPServer[] | undefined;

//   const addMCPServer = () => {};
//   const updateMCPServer = () => {};
//   const deleteMCPServer = () => {};
//   const toggleMCPEnabled = () => {};
//   const seedOfficialMCPs = () => {};
//   const updateConnectionStatus = () => {};
//   const cleanupOfficialMCPs = () => {};
...
//       //   const hasFirecrawl = mcpServers.some(
//       //     (mcp) => mcp.name === "Firecrawl" && mcp.isOfficial
//       //   );
//       //   if (!hasFirecrawl) {
...
//                 <p className="text-body-small text-black-alpha-48 mt-12">
...
//                       const providerKey = userLLMKeys?.find(
...
//                               <StatusIcon
//                                 configured={!!(providerKey || hasEnvKey)}
//                               />
//                               <div>
//                                 <p className="text-body-small text-accent-black font-medium capitalize">
//                                   {provider}
//                                 </p>
//                                 {providerKey ? (
//                                   <p className="text-xs text-black-alpha-48">
//                                     Key: {providerKey.keyPrefix}{" "}
//                                     {providerKey.label &&
//                                       `(${providerKey.label})`}
//                                   </p>
//                                 ) : hasEnvKey ? (
...
//                       <strong>Note:</strong> Your API keys take priority over
//                       environment variables. Keys are encrypted and stored
//                       securely per user.
//                     </p>
//                   </div>
//                 </div>
...
//                 {/* Integrations */}
//                 <div>
//                   <h3 className="text-label-large font-medium text-accent-black mb-12">
//                     Integrations
//                   </h3>
//                   <div className="grid grid-cols-1 gap-8">
//                     <div className="flex items-center gap-8 p-10 bg-background-base rounded-8 border border-border-faint">
//                       <StatusIcon
//                         configured={serverConfig?.firecrawlConfigured || false}
//                       />
//                       <div className="min-w-0">
//                         <p className="text-body-small text-accent-black font-medium truncate">
//                           Firecrawl
//                         </p>
//                       </div>
//                     </div>
...
//                             {key.name}
//                           </p>
//                           <code className="text-xs text-black-alpha-48 font-mono">
//                             {key.keyPrefix}
//                           </code>
...
//                         No API keys yet. Generate one to access workflows via
//                         API.
//                       </p>
//                     )}
//                   </div>
...
//                           setTestingMCPs(
//                             (prev) =>
//                               new Set(Array.from(prev).concat(server._id))
//                           );
//                           try {
...
//                         LLM & Integration keys are set in{" "}
...
//                   await addMCPServer();
//                   toast.success(
//                     `${data.name} added with ${data.tools.length} tools`
//                   );
//                 } else {
//                   // Otherwise, test the connection first to discover tools
//                   const loadingToast = toast.loading(
//                     `Testing connection to ${data.name}...`
//                   );
...
//                       description:
//                         testResult.error || "Unable to discover tools",
//                       id: loadingToast,
//                     });
...
//               toast.info(
//                 `Testing ${importedServers.length} imported server${
//                   importedServers.length > 1 ? "s" : ""
//                 }...`
//               );
...
//       case "connected":
//         return "text-heat-100";
//       case "error":
//         return "text-accent-black";
//       default:
//         return "text-black-alpha-32";
//     }
//   };
...
//       case "api-key":
//         return <Key className="w-12 h-12 text-black-alpha-48" />;
//       case "bearer":
//         return <Shield className="w-12 h-12 text-black-alpha-48" />;
//       case "oauth-coming-soon":
//         return <Lock className="w-12 h-12 text-black-alpha-32" />;
//       default:
//         return null;
//     }
//   };
...
//   return (
//     <div
//       className={`bg-background-base rounded-8 border ${
//         server.enabled
//           ? "border-border-faint"
//           : "border-black-alpha-8 opacity-60"
//       }`}
//     >
//       {/* Header */}
...
//               </div>
//               <div>
//                 <p className="text-xs text-black-alpha-48 mb-4">
//                   Authentication
//                 </p>
//                 <div className="flex items-center gap-4">
//                   <span className="text-xs text-accent-black capitalize">
//                     {server.authType === "oauth-coming-soon"
//                       ? "OAuth (Coming Soon)"
//                       : server.authType.replace("-", " ")}
//                   </span>
//                   {server.accessToken && (
//                     <span className="text-xs text-black-alpha-32">•••••••</span>
//                   )}
//                 </div>
//               </div>
//             </div>
...
//                     <span
//                       key={tool}
//                       className="px-8 py-4 bg-black-alpha-4 text-xs text-accent-black rounded-4"
//                     >
//                       {tool}
//                     </span>
//                   ))}
...
//               <option value="oauth-coming-soon" disabled>
//                 OAuth (Coming Soon)
//               </option>
//             </select>
//           </div>
...
//                 }
//                 placeholder={
//                   formData.authType === "api-key" ? "sk-..." : "Bearer token"
//                 }
//                 className="w-full px-12 py-8 bg-background-base border border-border-faint rounded-8 text-body-small text-accent-black font-mono"
//               />
//             </div>
...
//                     <span
//                       key={tool}
//                       className="px-6 py-2 bg-white text-heat-100 rounded-4 text-xs font-medium border border-heat-100"
//                     >
//                       {tool}
//                     </span>
//                   ))}
...
//           <h3 className="text-title-h4 text-accent-black">
//             {selectedProvider
//               ? `Update ${selectedProvider} API Key`
//               : "Add LLM API Key"}
//           </h3>
//         </div>
...
//                 setFormData({
//                   ...formData,
//                   provider: e.target.value as "anthropic" | "openai" | "groq",
//                 })
//               }
...
//             <p className="text-xs text-black-alpha-64">
//               <strong>Security:</strong> Your API key will be encrypted and
//               stored securely. It will only be accessible by you and never
//               shared across users.
//             </p>
//           </div>
//         </div>
...
const SettingsPanelSimple = () => {
  return <div>SettingsPanelSimple</div>;
};
